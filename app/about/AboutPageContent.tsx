          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            ...
            >
              ...
              <motion.div className="space-y-5 text-cream/60 text-base leading-relaxed font-sans text-justify" variants={stagger(0.12)} initial="hidden" whileInView="visible" viewport={viewport}>
                {[
                  "White Tab Partners LLP is a full-service law firm with experience across litigation, arbitration, corporate advisory, and forensic matters. We advise clients in complex disputes, commercial transactions, and cross-border engagements from our offices in New Delhi and Dubai, supported by a dedicated India-UAE international desk.",
                  "Our litigation practice spans the full hierarchy of Indian courts and tribunals. We appear before the Supreme Court of India, including before Constitution Benches, and before the Delhi High Court and other High Courts across the country. We act in matters before district and subordinate courts and before specialist forums including the National Company Law Tribunal (NCLT) and the National Company Law Appellate Tribunal (NCLAT), the Debt Recovery Tribunal (DRT), and consumer forums. Our disputes work covers civil and commercial litigation, insolvency and company-law proceedings, criminal matters under the Negotiable Instruments Act, and recovery actions.",
                  "On the advisory side, we handle domestic and international arbitration, corporate and commercial advisory, contract drafting and vetting, and transactional work, including cross-border arrangements. Members of the firm hold senior counsel appointments for the Government of India and bring experience drawn from regulatory and enforcement practice.",
                  "Where a matter demands it, we work alongside associated Chartered Accountants, Company Secretaries, and forensic professionals, bringing stronger factual, financial, and commercial depth to disputes, investigations, and recovery work.",
                ].map((p, i) => (
